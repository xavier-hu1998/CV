...
void detectAndDisplay(Mat frame, string fileName)
{
    ...
    cv::inRange(frame_HSV, Scalar(0, 70, 50), Scalar(10, 255, 255), frame_HSV_high);
    cv::inRange(frame_HSV, Scalar(170, 70, 50), Scalar(180, 255, 255), frame_HSV_low);
    Mat HSV = frame_HSV_high + frame_HSV_low;
    imshow("red", HSV);
	imwrite("subtask_4/red.jpg", HSV);

	Mat dst;
	GaussianBlur(HSV, dst, Size(5, 5), 1, 1, BORDER_DEFAULT);
	...
	imwrite("subtask_4/sobel_image.jpg",dst);
	...
	if (fileName == "No_entry/NoEntry0.bmp")
	{
		...
		TP = TP_1 + TP_2;
		num_GT = 2;
		imwrite( "subtask_4/detected_0.jpg", frame );
	};
	if (fileName == "No_entry/NoEntry1.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_1.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry2.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_2.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry3.bmp")
	{
		...
		TP = TP_1 + TP_2;
		num_GT = 2;
		imwrite( "subtask_4/detected_3.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry4.bmp")
	{
		...
		TP = TP_1 + TP_2;
		num_GT = 2;
		imwrite( "subtask_4/detected_4.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry5.bmp")
	{
		...
		num_GT = 10;
		imwrite( "subtask_4/detected_5.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry6.bmp")
	{
		...
		num_GT = 4;
		imwrite( "subtask_4/detected_6.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry7.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_7.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry8.bmp")
	{
		...
		TP = TP_1 + TP_2 + TP_3 + TP_4;
		num_GT = 4;
		imwrite( "subtask_4/detected_8.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry9.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_9.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry10.bmp")
	{
		...
		TP = TP_1 + TP_2 + TP_3;
		num_GT = 3;
		imwrite( "subtask_4/detected_10.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry11.bmp")
	{
		...
		TP = TP_1 + TP_2;
		num_GT = 2;
		imwrite( "subtask_4/detected_11.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry12.bmp")
	{
		...
		num_GT = 6;
		imwrite( "subtask_4/detected_12.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry13.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_13.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry14.bmp")
	{
		...
		num_GT = 1;
		imwrite( "subtask_4/detected_14.jpg", frame );
	};
	...
	if (fileName == "No_entry/NoEntry15.bmp")
	{
		...
		TP = TP_1 + TP_2;
		num_GT = 2;
		imwrite( "subtask_4/detected_15.jpg", frame );
	};
...
// g++ subtask_4.cpp /usr/lib64/libopencv_core.so.2.4 /usr/lib64/libopencv_highgui.so.2.4 /usr/lib64/libopencv_imgproc.so.2.4 /usr/lib64/libopencv_objdetect.so.2.4

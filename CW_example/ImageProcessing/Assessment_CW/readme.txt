# ImageProcessing
Coursework in Image Processing and Computer Vision on the University of Bristol in 2018.
...
## Getting started
* cd in the main directory of this project and use make command to build and train model and compile all c++ sources: make 
